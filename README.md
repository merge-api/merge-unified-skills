...
Codex skills are pre-converted and committed under [`dist/codex/skills/`](dist/codex/skills), so you can install them in two commands without running `convert.sh`:

```bash
git clone https://github.com/merge-api/merge-unified-skills.git
mkdir -p /path/to/your/project/.codex && cp -r merge-unified-skills/dist/codex/skills /path/to/your/project/.codex/skills
```
