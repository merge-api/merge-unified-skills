...
Tech stack and ORM identified (either from Step 1 of `implementing-merge-link`, or by scanning the codebase now).
...
If invoked from `implementing-merge-link`, both were answered in Steps 1b and 1d — use that context. Otherwise, ask the user now:
