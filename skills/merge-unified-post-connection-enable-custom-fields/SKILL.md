---
name: merge-unified-post-connection-enable-custom-fields
...
Custom fields fundamentals loaded (`../merge-unified-implementing-post-connection/references/post-connection-fundamentals.md`).
...
- **Existing field-mapping or settings UI?** If a settings page already exists (see `merge-unified-post-connection-build-settings-page`), the field selector inserts there rather than creating a new page.
