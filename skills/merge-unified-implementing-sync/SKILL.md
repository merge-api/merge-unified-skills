---
name: merge-unified-implementing-sync
description: >
...
- **2a. Webhooks (PRIMARY for production)** — invoke `merge-unified-sync-implement-webhooks`
...
- **2b. Polling (development starting point and production fallback)** — invoke `merge-unified-sync-implement-polling`
