---
name: merge-unified-link-setup-database
...
Tech stack and ORM identified (either from Step 1 of `merge-unified-implementing-link`, or by scanning the codebase now).
...
If invoked from `merge-unified-implementing-link`, both were answered in Steps 1b and 1d — use that context. Otherwise, ask the user now:
